...
extern int       setlen         (BitList *l, int newlen);
extern int       setpos         (BitList *l, int newpos);

extern void      read_open      (BitList *l);
extern void      write_open     (BitList *l);
extern void      write_close    (BitList *l);

extern WTYPE     vread          (BitList *l, int bits);
extern WTYPE     vreadahead     (BitList *l, int bits);
extern void      vwrite         (BitList *l, int bits, WTYPE value);
